...
if (Input::exists()) {
    if (Token::check()) {
        ...
        $settings = [
            'ENOT/shopuuid_key' => $_POST['shopuuid_key'],
            'ENOT/secret1_key' => $_POST['secret1_key'],
            'ENOT/secret2_key' => $_POST['secret2_key'],
            'ENOT/enot_callb' => $_POST['enot_callb'],
            'ENOT/enot_apiurl' => $_POST['enot_apiurl']
        ];
